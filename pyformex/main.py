...
def run(argv=[]):
    ...
    MO("--testmodule",
       ...
       help="Run the docstring tests for module TESTMODULE. TESTMODULE is the name of a pyFormex module (Python syntax).",
       ),
    MO("--docmodule",
       action="store", dest="docmodule", default=None,
       help="Print the autogenerated documentation for module DOCMODULE. This is mostly useful during the generation of the pyFormex reference manual, as the produced result still needs to be run through the Sphinx documentation generator. DOCMODULE is the name of a pyFormex module (Python syntax).",
       ),
    MO("--testcamera",
    ...
    MO("--gl1",
       ...
       help="Use the old OpenGL rendering engine. This is almost identical to the engine in the old 0.9 branch, but does not provide some new and advanced features of the new engine. This option is currently broken.",
       ),
    MO("--gl2",
       action="store_true", dest="opengl2", default=True,
       help="Use the new OpenGL rendering engine. This is now the default, so use of the option is unneeded.",
       ),
    MO("--oldabq",
    ...
    MO("--listmodules",
       ...
       help="List the pyFormex Python modules in the specified subpackage. The default is to list all. Specify 'core' to just list the modules not in any subpackage.",
       ),
    MO("--search",
