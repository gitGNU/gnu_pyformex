...
from opengl.webgl import WebGL
...
def run():
    ...
    S.attrib(color=red,alpha=0.7,caption='A sphere',control = ['visible','opacity','color'])
    S.setNormals('avg')

    T.attrib(color=blue,caption='A cone',alpha=1.0,control = ['visible','opacity','color'])
    #S.setNormals('auto')

    C.attrib(color=yellow,caption='A cylinder',alpha=0.8,control = ['visible','opacity','color'])
    #S.setNormals('auto')
