...
.. _`bumps`: http://bumps.ugent.be/webgl
...
Below are some examples. Click on the link or on the image to see the 3D model.
More WebGL models generated by pyFormex can be found on our `bumps`_ server.
