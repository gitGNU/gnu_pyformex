...
sys.path.insert(0,os.path.abspath('../pyformex/opengl'))
...
extensions = ['sphinx.ext.autodoc','sphinx.ext.imgmath', 'sphinx.ext.autosummary',] #  'sphinx.ext.viewcode'] #'sphinx.ext.jsmath',
...
project = u'pyFormex'
copyright = u'2004-2015, Benedict Verhegghe'
